...
- INT-06: cross-boundary sentinel suite is experimental and default-off. Live suite stays unproved (`MISS-INT06-LIVE`); do not invent a live pass, hide failures with post-hoc criteria, or fetch npm.ch5.me.
