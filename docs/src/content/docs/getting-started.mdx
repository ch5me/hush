...
<Tabs>
  ...
  <TabItem label="Windows">
    ...
    **Note:** Windows support is best-effort and not yet covered by CI. If you encounter issues, please open a project issue.
  </TabItem>
</Tabs>
...
See the [completion command reference](/reference/commands/#completion) for details.
